...
namespace BuildingBuddies.Data
{
    public class DbInitializer
    {
        public static void Initialize (BuildingBuddiesContext context)
        {
            ...
            var users = new User[]
            {
                new User{Email="email1@erstebank.com", UserName="ananas", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "eSlužba 1").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 1").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "erstebank.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email2@erstebank.com", UserName="banana", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "eSlužba 1").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 1").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "erstebank.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email3@erstebank.com", UserName="jabuka", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "eSlužba 2").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 2").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "erstebank.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email4@erstebank.com", UserName="kruska", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "eSlužba 2").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 2").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "erstebank.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email5@erstebank.com", UserName="gljiva", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "eSlužba 2").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 2").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "erstebank.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email6@erstebank.com", UserName="sljiva", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "eSlužba 3").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 3").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "erstebank.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email7@erstebank.com", UserName="perec", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "eSlužba 3").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 3").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "erstebank.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email1@otp.com", UserName="kifla", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 1").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 1").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email2@otp.com", UserName="krafna", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 1").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 1").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email3@otp.com", UserName="piroska", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 1").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 1").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email4@otp.com", UserName="prstic", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 1").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 1").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email5@otp.com", UserName="prskalica", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 2").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 2").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email6@otp.com", UserName="kojot", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 2").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 2").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email7@otp.com", UserName="nosorog", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 2").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 2").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email8@otp.com", UserName="hijena", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 2").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 2").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email9@otp.com", UserName="pas", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 3").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 3").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/},
                new User{Email="email10@otp.com", UserName="mrkva", EmailConfirmed=true, SecurityStamp = Guid.NewGuid().ToString("D"), DepartmentID=departments.Single(d => d.Name == "oSlužba 3").DepartmentID, MeetingID=departments.Single(d => d.Name == "eSlužba 3").MeetingID/*, AgreedMeetingID=agreedMeetings.Single(am => am.MeetingID == meetings.Single(m => m.Domain == "otp.com").MeetingID).AgreedMeetingID*/}
            };            
